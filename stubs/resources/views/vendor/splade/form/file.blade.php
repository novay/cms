...
>
    <template #default="{!! $scope !!}">
        <label class="block">
            ...
            @else
                <a @submit.prevent
                    class="inline-block py-2 px-3 rounded-md border border-stone-300 shadow-sm bg-white hover:bg-stone-100 relative cursor-pointer font-medium text-stone-700 text-sm focus:outline-none focus:ring focus:ring-opacity-50 focus:border-indigo-300 focus:ring-indigo-200 text-center">
