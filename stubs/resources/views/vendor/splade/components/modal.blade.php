        ...
        <div class="flex min-h-full justify-center" v-bind:class="{
            ...
            <x-splade-component is="transition" child animation="fade" after-leave="modal.emitClose" animate="modal.animate" v-bind:class="{
                ...
                <x-splade-component is="dialog" panel dusk="modal-dialog">
                        <div {{ $attributes->class('bg-white dark:bg-stone-900 p-5 rounded-none relative') }}>
                        <div v-if="modal.closeButton" class="absolute top-0 right-0 pt-4 pr-3">
                            <button dusk="close-modal-button" @click="modal.close" type="button" class="text-stone-400 hover:text-stone-500">
